...
const { db: { User, Mcq, Question, Submission, Company, PlatformSettings }, protect } = require('shared');
...
router.delete('/mcqs/:id', protect, async (req, res) => {
  try {
    ...
    const { db: { McqAttempt, UserStats } } = require('shared');
...
router.delete('/users/:id', protect, async (req, res) => {
  try {
    ...
    const { db: { McqAttempt } } = require('shared');
